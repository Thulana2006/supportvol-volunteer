...
const NavbarC: React.FC<NavbarProps> = ({ selectedItem, userName, userProfile, userEmail, selectedIcon, communityName, communityID
}) => {
    ...
    return (
        <div className="navbar flex justify-between items-center">
            <div className="flex items-center gap-4">
                ...
                <Breadcrumb className='bg-secondary p-2.5 rounded hidden lg:flex'>
                    <BreadcrumbList>
                        <BreadcrumbItem>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>{communityName}</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
            <div className="flex items-center space-x-2">
                <Input placeholder={"search " + communityName} className='hidden sm:block w-72 focus-visible:ring-0 focus-visible:ring-offset-0' />
